...
- Seeded the Chapter 08 **Inventory, Resources, And Encumbrance** research dossier, mapping inventory collections, item gates, consumables, counted resources, equipment records, constraints, and Campaign Ledger equipment/resource evidence.
- Seeded the Chapter 09 **The Dungeon Master And The Admin** research dossier, mapping role-based access, capabilities, ownership, guard placement, player-safe publishing, author/debug boundaries, and Campaign Ledger permission evidence.
- Seeded the Chapter 10 **Adventure Modules And Programming Modules** research dossier, mapping modularity, public contracts, dependency direction, package adoption, compatibility shims, gamebook module boundaries, and Campaign Ledger Hyper-Dank evidence.
- Seeded the Chapter 11 **Rules As Structured Data** research dossier, mapping parsing, provenance, source precedence, schema design, licence-aware imports, gamebook SRD catalogues, and Campaign Ledger rules-source evidence.
- Seeded the Chapter 12 **Saving The Game** research dossier, mapping local storage, JSON save documents, validation, schema versioning, migrations, SQLite source-of-truth boundaries, export/import, and backup/restore evidence.
...
- Added shelf references across all research dossiers so each chapter points to concrete books for drafting, including owned software-engineering books, D&D 2014 core books/SRD guardrails, and Fighting Fantasy or gamebook form references where useful.
- Added a supplementary reading list for non-D&D and non-Fighting-Fantasy background books, with summaries, chapter uses, source links, and a suggested buying order.
